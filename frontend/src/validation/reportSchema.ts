...
const sensingAmplitude = z.number()
  ...
  .max(25, 'Sensing amplitude cannot exceed 25 mV')
...
export const reportSchema = z.object({
  ...
  completedByUserId: z.number().optional().nullable(),
  completedByName: z.string().optional().nullable(),
  completedBySignature: z.string().optional().nullable(),

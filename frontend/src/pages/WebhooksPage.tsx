        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              ...
              notifications for battery alerts, task reminders, and more.
            </p>
          </CardContent>
        </Card>
      ) : (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {webhook.integrationType &&
                          webhook.integrationType !== "generic" && (
                            <Badge variant="outline" className="capitalize">
                              {webhook.integrationType === "epic" &&
                                "🏥 Epic FHIR"}
                              {webhook.integrationType === "slack" &&
                                "💬 Slack"}
                              {webhook.integrationType === "teams" &&
                                "📋 Teams"}
                            </Badge>
                          )}
                      </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              be undone and you will stop receiving notifications for subscribed
              events.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>

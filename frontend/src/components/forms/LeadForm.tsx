        ...
        <CardContent className="pt-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="leadModel">Model</Label>
                <Input
                  id="leadModel"
                  name="leadModel"
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleSelectChange("connector", value)
                  }
                  required
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleSelectChange("polarity", value)
                  }
                  required
                >
                  <SelectTrigger>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                id="isMri"
                name="isMri"
                checked={formData.isMri}
                onCheckedChange={(checked) =>
                  setFormData((prev) => ({ ...prev, isMri: !!checked }))
                }
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setFormData((prev) => ({ ...prev, hasAlert: !!checked }))
                }
              />
              <Label htmlFor="hasAlert">Alert</Label>
            </div>

    ...
    (
        ...
        React.useEffect(() => {
            const handleKeyDown = (event: KeyboardEvent) => {
                ...
                if (
                    (event.key === SIDEBAR_KEYBOARD_SHORTCUT || event.key === SIDEBAR_KEYBOARD_SHORTCUT.toUpperCase()) &&
    ...
    return (
        <main
            ...
            className={cn(
                ...
                "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]/sidebar-wrapper:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
                className
            )}
            {...props}
        />

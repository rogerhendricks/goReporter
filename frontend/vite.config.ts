...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        maximumFileSizeToCacheInBytes: 5000000, // 5 MB to accommodate pdf-vendor chunk
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          "pdf-vendor": ["@react-pdf/renderer", "pdf-lib", "pdfjs-dist"],
          ...
          // XML/Excel parsing
          "data-vendor": ["fast-xml-parser", "xlsx"],
  ...
  server: {
    ...
    host: "0.0.0.0",
    allowedHosts: [
      "dev.nuttynarwhal.com",
      "dev-mini.nuttynarwhal.com",
      "localhost",
    ],
    proxy: {
      "/api": {

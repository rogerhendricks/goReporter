...
func seed(db *gorm.DB) error {
    ...
    devices := []models.Device{
        ...
        {Name: "Advisa DR MRI", Manufacturer: "Medtronic", DevModel: "A3DR01", IsMri: true, Type: "Pacemaker"},
        {Name: "Claria MRI Quad CRT-D", Manufacturer: "Medtronic", DevModel: "DTMA2Q1", IsMri: true, Type: "Defibrillator"},

...
func seed(db *gorm.DB) error {
	...
	devices := []models.Device{
		...
		{Name: "Accolade", Manufacturer: "Boston Scientific", DevModel: "L311", IsMri: true, HasAlert: true, Type: "Pacemaker"},
		{Name: "Accolade", Manufacturer: "Boston Scientific", DevModel: "L331", IsMri: true, HasAlert: true, Type: "Pacemaker"},

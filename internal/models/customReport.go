...
type ReportField struct {
	...
	AggregationType     string `json:"aggregation_type,omitempty"`     // "donut_chart", "bar_chart"
	GroupByField        string `json:"group_by_field,omitempty"`       // Field to group by
	AggregationFunction string `json:"aggregation_function,omitempty"` // "COUNT", "SUM", "AVG"
}
